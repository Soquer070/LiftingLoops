...
; CHECK1-NEXT:    [[TMP1:%.*]] = call i64 @llvm.umax.i64(i64 6, i64 [[TMP0]])
...
; CHECK1-NEXT:    [[TMP2:%.*]] = shl nuw nsw i64 [[WIDE_TRIP_COUNT]], 3
; CHECK1-NEXT:    [[SCEVGEP:%.*]] = getelementptr i8, ptr [[DY:%.*]], i64 [[TMP2]]
; CHECK1-NEXT:    [[SCEVGEP1:%.*]] = getelementptr i8, ptr [[DX:%.*]], i64 [[TMP2]]
; CHECK1-NEXT:    [[BOUND0:%.*]] = icmp ult ptr [[DY]], [[SCEVGEP1]]
; CHECK1-NEXT:    [[BOUND1:%.*]] = icmp ult ptr [[DX]], [[SCEVGEP]]
...
; CHECK1-NEXT:    [[TMP5:%.*]] = getelementptr inbounds double, ptr [[DX]], i64 [[TMP4]]
; CHECK1-NEXT:    [[TMP6:%.*]] = getelementptr inbounds double, ptr [[TMP5]], i32 0
; CHECK1-NEXT:    [[WIDE_LOAD:%.*]] = load <vscale x 1 x double>, ptr [[TMP6]], align 8, !tbaa [[TBAA2:![0-9]+]], !alias.scope !6
; CHECK1-NEXT:    [[TMP7:%.*]] = fmul <vscale x 1 x double> [[WIDE_LOAD]], [[BROADCAST_SPLAT]]
; CHECK1-NEXT:    [[TMP8:%.*]] = getelementptr inbounds double, ptr [[DY]], i64 [[TMP4]]
; CHECK1-NEXT:    [[TMP9:%.*]] = getelementptr inbounds double, ptr [[TMP8]], i32 0
; CHECK1-NEXT:    [[WIDE_LOAD2:%.*]] = load <vscale x 1 x double>, ptr [[TMP9]], align 8, !tbaa [[TBAA2]], !alias.scope !9, !noalias !6
; CHECK1-NEXT:    [[TMP10:%.*]] = fadd <vscale x 1 x double> [[WIDE_LOAD2]], [[TMP7]]
; CHECK1-NEXT:    store <vscale x 1 x double> [[TMP10]], ptr [[TMP9]], align 8, !tbaa [[TBAA2]], !alias.scope !9, !noalias !6
; CHECK1-NEXT:    [[TMP11:%.*]] = call i64 @llvm.vscale.i64()
; CHECK1-NEXT:    [[INDEX_NEXT]] = add nuw i64 [[INDEX]], [[TMP11]]
; CHECK1-NEXT:    [[TMP12:%.*]] = icmp eq i64 [[INDEX_NEXT]], [[N_VEC]]
; CHECK1-NEXT:    br i1 [[TMP12]], label [[MIDDLE_BLOCK:%.*]], label [[VECTOR_BODY]], !llvm.loop [[LOOP11:![0-9]+]]
; CHECK1:       middle.block:
...
; CHECK1-NEXT:    [[TMP13:%.*]] = load double, ptr [[ARRAYIDX]], align 8, !tbaa [[TBAA2]]
; CHECK1-NEXT:    [[MUL:%.*]] = fmul double [[TMP13]], [[A]]
; CHECK1-NEXT:    [[ARRAYIDX2:%.*]] = getelementptr inbounds double, ptr [[DY]], i64 [[INDVARS_IV]]
; CHECK1-NEXT:    [[TMP14:%.*]] = load double, ptr [[ARRAYIDX2]], align 8, !tbaa [[TBAA2]]
; CHECK1-NEXT:    [[ADD:%.*]] = fadd double [[TMP14]], [[MUL]]
