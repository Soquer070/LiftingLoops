...
; RUN: opt -mtriple riscv64 -mattr +m,+a,+f,+d,+zepi -enable-mem-access-versioning=0 \
...
; STRIDED-NEXT:    [[TMP0:%.*]] = sext i32 [[BSTRIDE:%.*]] to i64
; STRIDED-NEXT:    [[TMP1:%.*]] = sext i32 [[SHL]] to i64
; STRIDED-NEXT:    [[TMP2:%.*]] = sext i32 [[MUL19]] to i64
; STRIDED-NEXT:    [[TMP3:%.*]] = sext i32 [[MUL33]] to i64
; STRIDED-NEXT:    [[TMP4:%.*]] = sext i32 [[MUL47]] to i64
; STRIDED-NEXT:    [[TMP5:%.*]] = sext i32 [[MUL61]] to i64
; STRIDED-NEXT:    [[TMP6:%.*]] = sext i32 [[MUL75]] to i64
; STRIDED-NEXT:    [[TMP7:%.*]] = sext i32 [[MUL89]] to i64
; STRIDED-NEXT:    [[TMP8:%.*]] = sext i32 [[SHR]] to i64
; STRIDED-NEXT:    [[TMP9:%.*]] = sext i32 [[MUL150]] to i64
; STRIDED-NEXT:    [[TMP10:%.*]] = sext i32 [[MUL164]] to i64
; STRIDED-NEXT:    [[TMP11:%.*]] = sext i32 [[MUL178]] to i64
; STRIDED-NEXT:    [[TMP12:%.*]] = sext i32 [[MUL192]] to i64
; STRIDED-NEXT:    [[TMP13:%.*]] = sext i32 [[MUL206]] to i64
; STRIDED-NEXT:    [[TMP14:%.*]] = sext i32 [[MUL220]] to i64
; STRIDED-NEXT:    [[WIDE_TRIP_COUNT:%.*]] = zext i32 [[BATCHES]] to i64
; STRIDED-NEXT:    [[TMP15:%.*]] = shl nsw i64 [[TMP0]], 3
; STRIDED-NEXT:    [[SCEVGEP:%.*]] = getelementptr i8, ptr [[VA:%.*]], i64 8
; STRIDED-NEXT:    [[TMP16:%.*]] = shl nsw i64 [[TMP1]], 3
; STRIDED-NEXT:    [[SCEVGEP1:%.*]] = getelementptr i8, ptr [[VA]], i64 [[TMP16]]
; STRIDED-NEXT:    [[TMP17:%.*]] = shl nsw i64 [[TMP1]], 3
; STRIDED-NEXT:    [[TMP18:%.*]] = or i64 [[TMP17]], 8
; STRIDED-NEXT:    [[SCEVGEP2:%.*]] = getelementptr i8, ptr [[VA]], i64 [[TMP18]]
; STRIDED-NEXT:    [[TMP19:%.*]] = shl nsw i64 [[TMP2]], 3
; STRIDED-NEXT:    [[SCEVGEP3:%.*]] = getelementptr i8, ptr [[VA]], i64 [[TMP19]]
; STRIDED-NEXT:    [[TMP20:%.*]] = shl nsw i64 [[TMP2]], 3
; STRIDED-NEXT:    [[TMP21:%.*]] = or i64 [[TMP20]], 8
; STRIDED-NEXT:    [[SCEVGEP4:%.*]] = getelementptr i8, ptr [[VA]], i64 [[TMP21]]
; STRIDED-NEXT:    [[TMP22:%.*]] = shl nsw i64 [[TMP3]], 3
; STRIDED-NEXT:    [[SCEVGEP5:%.*]] = getelementptr i8, ptr [[VA]], i64 [[TMP22]]
; STRIDED-NEXT:    [[TMP23:%.*]] = shl nsw i64 [[TMP3]], 3
; STRIDED-NEXT:    [[TMP24:%.*]] = or i64 [[TMP23]], 8
; STRIDED-NEXT:    [[SCEVGEP6:%.*]] = getelementptr i8, ptr [[VA]], i64 [[TMP24]]
; STRIDED-NEXT:    [[TMP25:%.*]] = shl nsw i64 [[TMP4]], 3
; STRIDED-NEXT:    [[SCEVGEP7:%.*]] = getelementptr i8, ptr [[VA]], i64 [[TMP25]]
; STRIDED-NEXT:    [[TMP26:%.*]] = shl nsw i64 [[TMP4]], 3
; STRIDED-NEXT:    [[TMP27:%.*]] = or i64 [[TMP26]], 8
; STRIDED-NEXT:    [[SCEVGEP8:%.*]] = getelementptr i8, ptr [[VA]], i64 [[TMP27]]
; STRIDED-NEXT:    [[TMP28:%.*]] = shl nsw i64 [[TMP5]], 3
; STRIDED-NEXT:    [[SCEVGEP9:%.*]] = getelementptr i8, ptr [[VA]], i64 [[TMP28]]
; STRIDED-NEXT:    [[TMP29:%.*]] = shl nsw i64 [[TMP5]], 3
; STRIDED-NEXT:    [[TMP30:%.*]] = or i64 [[TMP29]], 8
; STRIDED-NEXT:    [[SCEVGEP10:%.*]] = getelementptr i8, ptr [[VA]], i64 [[TMP30]]
; STRIDED-NEXT:    [[TMP31:%.*]] = shl nsw i64 [[TMP6]], 3
; STRIDED-NEXT:    [[SCEVGEP11:%.*]] = getelementptr i8, ptr [[VA]], i64 [[TMP31]]
; STRIDED-NEXT:    [[TMP32:%.*]] = shl nsw i64 [[TMP6]], 3
; STRIDED-NEXT:    [[TMP33:%.*]] = or i64 [[TMP32]], 8
; STRIDED-NEXT:    [[SCEVGEP12:%.*]] = getelementptr i8, ptr [[VA]], i64 [[TMP33]]
; STRIDED-NEXT:    [[TMP34:%.*]] = shl nsw i64 [[TMP7]], 3
; STRIDED-NEXT:    [[SCEVGEP13:%.*]] = getelementptr i8, ptr [[VA]], i64 [[TMP34]]
; STRIDED-NEXT:    [[TMP35:%.*]] = shl nsw i64 [[TMP7]], 3
; STRIDED-NEXT:    [[TMP36:%.*]] = or i64 [[TMP35]], 8
; STRIDED-NEXT:    [[SCEVGEP14:%.*]] = getelementptr i8, ptr [[VA]], i64 [[TMP36]]
; STRIDED-NEXT:    [[SCEVGEP15:%.*]] = getelementptr i8, ptr [[VB:%.*]], i64 8
; STRIDED-NEXT:    [[TMP37:%.*]] = shl nsw i64 [[TMP8]], 3
; STRIDED-NEXT:    [[SCEVGEP16:%.*]] = getelementptr i8, ptr [[VB]], i64 [[TMP37]]
; STRIDED-NEXT:    [[TMP38:%.*]] = shl nsw i64 [[TMP8]], 3
; STRIDED-NEXT:    [[TMP39:%.*]] = add nsw i64 [[TMP38]], 8
; STRIDED-NEXT:    [[SCEVGEP17:%.*]] = getelementptr i8, ptr [[VB]], i64 [[TMP39]]
; STRIDED-NEXT:    [[TMP40:%.*]] = shl nsw i64 [[TMP9]], 3
; STRIDED-NEXT:    [[SCEVGEP18:%.*]] = getelementptr i8, ptr [[VB]], i64 [[TMP40]]
; STRIDED-NEXT:    [[TMP41:%.*]] = shl nsw i64 [[TMP9]], 3
; STRIDED-NEXT:    [[TMP42:%.*]] = or i64 [[TMP41]], 8
; STRIDED-NEXT:    [[SCEVGEP19:%.*]] = getelementptr i8, ptr [[VB]], i64 [[TMP42]]
; STRIDED-NEXT:    [[TMP43:%.*]] = shl nsw i64 [[TMP10]], 3
; STRIDED-NEXT:    [[SCEVGEP20:%.*]] = getelementptr i8, ptr [[VB]], i64 [[TMP43]]
; STRIDED-NEXT:    [[TMP44:%.*]] = shl nsw i64 [[TMP10]], 3
; STRIDED-NEXT:    [[TMP45:%.*]] = add nsw i64 [[TMP44]], 8
; STRIDED-NEXT:    [[SCEVGEP21:%.*]] = getelementptr i8, ptr [[VB]], i64 [[TMP45]]
; STRIDED-NEXT:    [[TMP46:%.*]] = shl nsw i64 [[TMP11]], 3
; STRIDED-NEXT:    [[SCEVGEP22:%.*]] = getelementptr i8, ptr [[VB]], i64 [[TMP46]]
; STRIDED-NEXT:    [[TMP47:%.*]] = shl nsw i64 [[TMP11]], 3
; STRIDED-NEXT:    [[TMP48:%.*]] = or i64 [[TMP47]], 8
; STRIDED-NEXT:    [[SCEVGEP23:%.*]] = getelementptr i8, ptr [[VB]], i64 [[TMP48]]
; STRIDED-NEXT:    [[TMP49:%.*]] = shl nsw i64 [[TMP12]], 3
; STRIDED-NEXT:    [[SCEVGEP24:%.*]] = getelementptr i8, ptr [[VB]], i64 [[TMP49]]
; STRIDED-NEXT:    [[TMP50:%.*]] = shl nsw i64 [[TMP12]], 3
; STRIDED-NEXT:    [[TMP51:%.*]] = add nsw i64 [[TMP50]], 8
; STRIDED-NEXT:    [[SCEVGEP25:%.*]] = getelementptr i8, ptr [[VB]], i64 [[TMP51]]
; STRIDED-NEXT:    [[TMP52:%.*]] = shl nsw i64 [[TMP13]], 3
; STRIDED-NEXT:    [[SCEVGEP26:%.*]] = getelementptr i8, ptr [[VB]], i64 [[TMP52]]
; STRIDED-NEXT:    [[TMP53:%.*]] = shl nsw i64 [[TMP13]], 3
; STRIDED-NEXT:    [[TMP54:%.*]] = or i64 [[TMP53]], 8
; STRIDED-NEXT:    [[SCEVGEP27:%.*]] = getelementptr i8, ptr [[VB]], i64 [[TMP54]]
; STRIDED-NEXT:    [[TMP55:%.*]] = shl nsw i64 [[TMP14]], 3
; STRIDED-NEXT:    [[SCEVGEP28:%.*]] = getelementptr i8, ptr [[VB]], i64 [[TMP55]]
; STRIDED-NEXT:    [[TMP56:%.*]] = shl nsw i64 [[TMP14]], 3
; STRIDED-NEXT:    [[TMP57:%.*]] = add nsw i64 [[TMP56]], 8
; STRIDED-NEXT:    [[SCEVGEP29:%.*]] = getelementptr i8, ptr [[VB]], i64 [[TMP57]]
...
; STRIDED-NEXT:    [[TMP64:%.*]] = getelementptr i8, ptr [[SCEVGEP]], i64 [[TMP63]]
...
; STRIDED-NEXT:    [[TMP66:%.*]] = getelementptr i8, ptr [[SCEVGEP1]], i64 [[TMP65]]
...
; STRIDED-NEXT:    [[TMP68:%.*]] = getelementptr i8, ptr [[SCEVGEP2]], i64 [[TMP67]]
...
; STRIDED-NEXT:    [[TMP70:%.*]] = getelementptr i8, ptr [[SCEVGEP3]], i64 [[TMP69]]
...
; STRIDED-NEXT:    [[TMP72:%.*]] = getelementptr i8, ptr [[SCEVGEP4]], i64 [[TMP71]]
...
; STRIDED-NEXT:    [[TMP74:%.*]] = getelementptr i8, ptr [[SCEVGEP5]], i64 [[TMP73]]
...
; STRIDED-NEXT:    [[TMP76:%.*]] = getelementptr i8, ptr [[SCEVGEP6]], i64 [[TMP75]]
...
; STRIDED-NEXT:    [[TMP78:%.*]] = getelementptr i8, ptr [[SCEVGEP7]], i64 [[TMP77]]
...
; STRIDED-NEXT:    [[TMP80:%.*]] = getelementptr i8, ptr [[SCEVGEP8]], i64 [[TMP79]]
...
; STRIDED-NEXT:    [[TMP82:%.*]] = getelementptr i8, ptr [[SCEVGEP9]], i64 [[TMP81]]
...
; STRIDED-NEXT:    [[TMP84:%.*]] = getelementptr i8, ptr [[SCEVGEP10]], i64 [[TMP83]]
...
; STRIDED-NEXT:    [[TMP86:%.*]] = getelementptr i8, ptr [[SCEVGEP11]], i64 [[TMP85]]
...
; STRIDED-NEXT:    [[TMP88:%.*]] = getelementptr i8, ptr [[SCEVGEP12]], i64 [[TMP87]]
...
; STRIDED-NEXT:    [[TMP90:%.*]] = getelementptr i8, ptr [[SCEVGEP13]], i64 [[TMP89]]
...
; STRIDED-NEXT:    [[TMP92:%.*]] = getelementptr i8, ptr [[SCEVGEP14]], i64 [[TMP91]]
...
; STRIDED-NEXT:    [[TMP96:%.*]] = getelementptr i8, ptr [[SCEVGEP15]], i64 [[TMP95]]
...
; STRIDED-NEXT:    [[TMP98:%.*]] = getelementptr i8, ptr [[SCEVGEP16]], i64 [[TMP97]]
...
; STRIDED-NEXT:    [[TMP100:%.*]] = getelementptr i8, ptr [[SCEVGEP17]], i64 [[TMP99]]
...
; STRIDED-NEXT:    [[TMP102:%.*]] = getelementptr i8, ptr [[SCEVGEP18]], i64 [[TMP101]]
...
; STRIDED-NEXT:    [[TMP104:%.*]] = getelementptr i8, ptr [[SCEVGEP19]], i64 [[TMP103]]
...
; STRIDED-NEXT:    [[TMP106:%.*]] = getelementptr i8, ptr [[SCEVGEP20]], i64 [[TMP105]]
...
; STRIDED-NEXT:    [[TMP108:%.*]] = getelementptr i8, ptr [[SCEVGEP21]], i64 [[TMP107]]
...
; STRIDED-NEXT:    [[TMP110:%.*]] = getelementptr i8, ptr [[SCEVGEP22]], i64 [[TMP109]]
...
; STRIDED-NEXT:    [[TMP112:%.*]] = getelementptr i8, ptr [[SCEVGEP23]], i64 [[TMP111]]
...
; STRIDED-NEXT:    [[TMP114:%.*]] = getelementptr i8, ptr [[SCEVGEP24]], i64 [[TMP113]]
...
; STRIDED-NEXT:    [[TMP116:%.*]] = getelementptr i8, ptr [[SCEVGEP25]], i64 [[TMP115]]
...
; STRIDED-NEXT:    [[TMP118:%.*]] = getelementptr i8, ptr [[SCEVGEP26]], i64 [[TMP117]]
...
; STRIDED-NEXT:    [[TMP120:%.*]] = getelementptr i8, ptr [[SCEVGEP27]], i64 [[TMP119]]
...
; STRIDED-NEXT:    [[TMP122:%.*]] = getelementptr i8, ptr [[SCEVGEP28]], i64 [[TMP121]]
...
; STRIDED-NEXT:    [[TMP124:%.*]] = getelementptr i8, ptr [[SCEVGEP29]], i64 [[TMP123]]
