...
define dso_local void @short_char(i64 noundef %N, ptr nocapture noundef writeonly %c, ptr nocapture noundef readonly %a, ptr nocapture noundef readonly %b) local_unnamed_addr #0 {
; CHECK-LABEL: define dso_local void @short_char
...
; CHECK-NEXT:    [[TMP7:%.*]] = call i64 @llvm.epi.vsetvl(i64 [[TMP6]], i64 1, i64 0)
; CHECK-NEXT:    [[TMP8:%.*]] = trunc i64 [[TMP7]] to i32
; CHECK-NEXT:    [[TMP9:%.*]] = getelementptr inbounds i16, ptr [[A]], i64 [[INDEX]]
; CHECK-NEXT:    [[VP_OP_LOAD:%.*]] = call <vscale x 4 x i16> @llvm.vp.load.nxv4i16.p0(ptr [[TMP9]], <vscale x 4 x i1> shufflevector (<vscale x 4 x i1> insertelement (<vscale x 4 x i1> poison, i1 true, i64 0), <vscale x 4 x i1> poison, <vscale x 4 x i32> zeroinitializer), i32 [[TMP8]]), !tbaa [[TBAA7:![0-9]+]], !alias.scope !11
; CHECK-NEXT:    [[TMP10:%.*]] = getelementptr inbounds i8, ptr [[B]], i64 [[INDEX]]
; CHECK-NEXT:    [[VP_OP_LOAD8:%.*]] = call <vscale x 4 x i8> @llvm.vp.load.nxv4i8.p0(ptr [[TMP10]], <vscale x 4 x i1> shufflevector (<vscale x 4 x i1> insertelement (<vscale x 4 x i1> poison, i1 true, i64 0), <vscale x 4 x i1> poison, <vscale x 4 x i32> zeroinitializer), i32 [[TMP8]]), !tbaa [[TBAA14:![0-9]+]], !alias.scope !15
; CHECK-NEXT:    [[VP_CAST:%.*]] = call <vscale x 4 x i16> @llvm.vp.zext.nxv4i16.nxv4i8(<vscale x 4 x i8> [[VP_OP_LOAD8]], <vscale x 4 x i1> shufflevector (<vscale x 4 x i1> insertelement (<vscale x 4 x i1> poison, i1 true, i64 0), <vscale x 4 x i1> poison, <vscale x 4 x i32> zeroinitializer), i32 [[TMP8]])
; CHECK-NEXT:    [[VP_OP:%.*]] = call <vscale x 4 x i16> @llvm.vp.add.nxv4i16(<vscale x 4 x i16> [[VP_OP_LOAD]], <vscale x 4 x i16> [[VP_CAST]], <vscale x 4 x i1> shufflevector (<vscale x 4 x i1> insertelement (<vscale x 4 x i1> poison, i1 true, i64 0), <vscale x 4 x i1> poison, <vscale x 4 x i32> zeroinitializer), i32 [[TMP8]])
; CHECK-NEXT:    [[TMP11:%.*]] = getelementptr inbounds i16, ptr [[C]], i64 [[INDEX]]
; CHECK-NEXT:    call void @llvm.vp.store.nxv4i16.p0(<vscale x 4 x i16> [[VP_OP]], ptr [[TMP11]], <vscale x 4 x i1> shufflevector (<vscale x 4 x i1> insertelement (<vscale x 4 x i1> poison, i1 true, i64 0), <vscale x 4 x i1> poison, <vscale x 4 x i32> zeroinitializer), i32 [[TMP8]]), !tbaa [[TBAA7]], !alias.scope !17, !noalias !19
...
; CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds i16, ptr [[A]], i64 [[I_010]]
; CHECK-NEXT:    [[TMP14:%.*]] = load i16, ptr [[ARRAYIDX]], align 2, !tbaa [[TBAA7]]
; CHECK-NEXT:    [[ARRAYIDX1:%.*]] = getelementptr inbounds i8, ptr [[B]], i64 [[I_010]]
; CHECK-NEXT:    [[TMP15:%.*]] = load i8, ptr [[ARRAYIDX1]], align 1, !tbaa [[TBAA14]]
; CHECK-NEXT:    [[CONV2:%.*]] = zext i8 [[TMP15]] to i16
; CHECK-NEXT:    [[ADD:%.*]] = add i16 [[TMP14]], [[CONV2]]
; CHECK-NEXT:    [[ARRAYIDX4:%.*]] = getelementptr inbounds i16, ptr [[C]], i64 [[I_010]]
; CHECK-NEXT:    store i16 [[ADD]], ptr [[ARRAYIDX4]], align 2, !tbaa [[TBAA7]]
...
for.body:                                         ; preds = %for.body.preheader, %for.body
  ...
  %arrayidx = getelementptr inbounds i16, ptr %a, i64 %i.010
  %0 = load i16, ptr %arrayidx, align 2, !tbaa !7
  %arrayidx1 = getelementptr inbounds i8, ptr %b, i64 %i.010
  %1 = load i8, ptr %arrayidx1, align 1, !tbaa !11
  %conv2 = zext i8 %1 to i16
  %add = add i16 %0, %conv2
  %arrayidx4 = getelementptr inbounds i16, ptr %c, i64 %i.010
  store i16 %add, ptr %arrayidx4, align 2, !tbaa !7
