...
; RUN: opt -S -mtriple riscv64 -mattr +zepi,+d --passes=loop-vectorize -prefer-predicate-over-epilogue=predicate-dont-vectorize -force-ordered-reductions -o - < %s | FileCheck %s
