...
; CHECK-NEXT:    [[TMP4:%.*]] = fdiv fast double 1.000000e+00, [[A]]
; CHECK-NEXT:    [[TMP5:%.*]] = insertelement <4 x double> poison, double [[TMP4]], i64 0
; CHECK-NEXT:    [[TMP6:%.*]] = shufflevector <4 x double> [[TMP5]], <4 x double> poison, <4 x i32> zeroinitializer
; CHECK-NEXT:    [[TMP7:%.*]] = fdiv fast double 1.000000e+00, [[A]]
; CHECK-NEXT:    [[TMP8:%.*]] = insertelement <4 x double> poison, double [[TMP7]], i64 0
; CHECK-NEXT:    [[TMP9:%.*]] = shufflevector <4 x double> [[TMP8]], <4 x double> poison, <4 x i32> zeroinitializer
; CHECK-NEXT:    [[TMP10:%.*]] = fdiv fast double 1.000000e+00, [[A]]
; CHECK-NEXT:    [[TMP11:%.*]] = insertelement <4 x double> poison, double [[TMP10]], i64 0
; CHECK-NEXT:    [[TMP12:%.*]] = shufflevector <4 x double> [[TMP11]], <4 x double> poison, <4 x i32> zeroinitializer
...
; CHECK-NEXT:    [[TMP17:%.*]] = fmul fast <4 x double> [[WIDE_LOAD]], [[TMP3]]
; CHECK-NEXT:    [[TMP18:%.*]] = fmul fast <4 x double> [[WIDE_LOAD6]], [[TMP6]]
; CHECK-NEXT:    [[TMP19:%.*]] = fmul fast <4 x double> [[WIDE_LOAD7]], [[TMP9]]
; CHECK-NEXT:    [[TMP20:%.*]] = fmul fast <4 x double> [[WIDE_LOAD8]], [[TMP12]]
...
; CHECK-NEXT:    store double [[TMP29]], ptr [[ARRAYIDX2_PROL]], align 8, !tbaa [[TBAA3]]
...
; CHECK-NEXT:    [[TMP30:%.*]] = icmp ult i64 [[TMP27]], 7
...
; CHECK-NEXT:    [[TMP37:%.*]] = fdiv fast double 1.000000e+00, [[A]]
; CHECK-NEXT:    [[TMP38:%.*]] = fdiv fast double 1.000000e+00, [[A]]
...
; CHECK-NEXT:    [[TMP39:%.*]] = fmul fast double [[T0]], [[TMP31]]
; CHECK-NEXT:    [[ARRAYIDX2:%.*]] = getelementptr inbounds double, ptr [[X]], i64 [[INDVARS_IV]]
; CHECK-NEXT:    store double [[TMP39]], ptr [[ARRAYIDX2]], align 8, !tbaa [[TBAA3]]
...
; CHECK-NEXT:    [[TMP40:%.*]] = fmul fast double [[T0_1]], [[TMP32]]
; CHECK-NEXT:    [[ARRAYIDX2_1:%.*]] = getelementptr inbounds double, ptr [[X]], i64 [[INDVARS_IV_NEXT]]
; CHECK-NEXT:    store double [[TMP40]], ptr [[ARRAYIDX2_1]], align 8, !tbaa [[TBAA3]]
...
; CHECK-NEXT:    [[TMP41:%.*]] = fmul fast double [[T0_2]], [[TMP33]]
; CHECK-NEXT:    [[ARRAYIDX2_2:%.*]] = getelementptr inbounds double, ptr [[X]], i64 [[INDVARS_IV_NEXT_1]]
; CHECK-NEXT:    store double [[TMP41]], ptr [[ARRAYIDX2_2]], align 8, !tbaa [[TBAA3]]
...
; CHECK-NEXT:    [[TMP42:%.*]] = fmul fast double [[T0_3]], [[TMP34]]
; CHECK-NEXT:    [[ARRAYIDX2_3:%.*]] = getelementptr inbounds double, ptr [[X]], i64 [[INDVARS_IV_NEXT_2]]
; CHECK-NEXT:    store double [[TMP42]], ptr [[ARRAYIDX2_3]], align 8, !tbaa [[TBAA3]]
...
; CHECK-NEXT:    [[TMP43:%.*]] = fmul fast double [[T0_4]], [[TMP35]]
; CHECK-NEXT:    [[ARRAYIDX2_4:%.*]] = getelementptr inbounds double, ptr [[X]], i64 [[INDVARS_IV_NEXT_3]]
; CHECK-NEXT:    store double [[TMP43]], ptr [[ARRAYIDX2_4]], align 8, !tbaa [[TBAA3]]
...
; CHECK-NEXT:    [[TMP44:%.*]] = fmul fast double [[T0_5]], [[TMP36]]
; CHECK-NEXT:    [[ARRAYIDX2_5:%.*]] = getelementptr inbounds double, ptr [[X]], i64 [[INDVARS_IV_NEXT_4]]
; CHECK-NEXT:    store double [[TMP44]], ptr [[ARRAYIDX2_5]], align 8, !tbaa [[TBAA3]]
...
; CHECK-NEXT:    [[TMP45:%.*]] = fmul fast double [[T0_6]], [[TMP37]]
; CHECK-NEXT:    [[ARRAYIDX2_6:%.*]] = getelementptr inbounds double, ptr [[X]], i64 [[INDVARS_IV_NEXT_5]]
; CHECK-NEXT:    store double [[TMP45]], ptr [[ARRAYIDX2_6]], align 8, !tbaa [[TBAA3]]
...
; CHECK-NEXT:    [[TMP46:%.*]] = fmul fast double [[T0_7]], [[TMP38]]
; CHECK-NEXT:    [[ARRAYIDX2_7:%.*]] = getelementptr inbounds double, ptr [[X]], i64 [[INDVARS_IV_NEXT_6]]
; CHECK-NEXT:    store double [[TMP46]], ptr [[ARRAYIDX2_7]], align 8, !tbaa [[TBAA3]]
