...
; CHECK-NEXT:    [[WIDE_LOAD:%.*]] = load <4 x float>, ptr [[TMP3]], align 4, !tbaa [[TBAA3:![0-9]+]]
; CHECK-NEXT:    [[TMP4:%.*]] = fmul fast <4 x float> [[WIDE_LOAD]], [[TMP2]]
; CHECK-NEXT:    store <4 x float> [[TMP4]], ptr [[TMP3]], align 4, !tbaa [[TBAA3]]
