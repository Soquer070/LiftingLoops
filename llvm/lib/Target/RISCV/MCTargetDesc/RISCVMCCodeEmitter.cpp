...
public:
  ...
  void expandEPIReadCSR(const MCInst &MI, SmallVectorImpl<char> &CB,
                        SmallVectorImpl<MCFixup> &Fixups,
...
void RISCVMCCodeEmitter::expandEPIReadCSR(const MCInst &MI,
                                          SmallVectorImpl<char> &CB,
                                          SmallVectorImpl<MCFixup> &Fixups,
...
void RISCVMCCodeEmitter::encodeInstruction(const MCInst &MI,
  ...
  if (MI.getOpcode() == RISCV::PseudoEPIReadVL ||
    ...
    expandEPIReadCSR(MI, CB, Fixups, STI, CSRNum);
  }
